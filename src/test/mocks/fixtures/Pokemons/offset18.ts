export const offset18 = {
  data: {
    pokemons: {
      count: 1302,
      next: "http://localhost/api/v2/pokemon/?limit=9&offset=27",
      previous: "http://localhost/api/v2/pokemon/?limit=9&offset=9",
      nextOffset: 27,
      prevOffset: 9,
      params: {
        limit: 9,
      ...
      results: [
        {
          ...
          id: 19,
          name: "rattata",
          url: "http://localhost/api/v2/pokemon/19/",
          artwork:
        ...
        },
        {
          ...
          id: 20,
          name: "raticate",
          url: "http://localhost/api/v2/pokemon/20/",
          artwork:
        ...
        },
        {
          ...
          id: 21,
          name: "spearow",
          url: "http://localhost/api/v2/pokemon/21/",
          artwork:
        ...
        },
        {
          ...
          id: 22,
          name: "fearow",
          url: "http://localhost/api/v2/pokemon/22/",
          artwork:
        ...
        },
        {
          ...
          id: 23,
          name: "ekans",
          url: "http://localhost/api/v2/pokemon/23/",
          artwork:
        ...
        },
        {
          ...
          id: 24,
          name: "arbok",
          url: "http://localhost/api/v2/pokemon/24/",
          artwork:
        ...
        },
        {
          ...
          id: 25,
          name: "pikachu",
          url: "http://localhost/api/v2/pokemon/25/",
          artwork:
        ...
        },
        {
          ...
          id: 26,
          name: "raichu",
          url: "http://localhost/api/v2/pokemon/26/",
          artwork:
        ...
        },
        {
          ...
          id: 27,
          name: "sandshrew",
          url: "http://localhost/api/v2/pokemon/27/",
          artwork:
