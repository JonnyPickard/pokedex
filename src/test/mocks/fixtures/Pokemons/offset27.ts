export const offset27 = {
  data: {
    pokemons: {
      count: 1302,
      next: "http://localhost/api/v2/pokemon/?limit=9&offset=36",
      previous: "http://localhost/api/v2/pokemon/?limit=9&offset=18",
      nextOffset: 36,
      prevOffset: 18,
      params: {
        limit: 9,
      ...
      results: [
        {
          ...
          id: 28,
          name: "sandslash",
          url: "http://localhost/api/v2/pokemon/28/",
          artwork:
        ...
        },
        {
          ...
          id: 29,
          name: "nidoran-f",
          url: "http://localhost/api/v2/pokemon/29/",
          artwork:
        ...
        },
        {
          ...
          id: 30,
          name: "nidorina",
          url: "http://localhost/api/v2/pokemon/30/",
          artwork:
        ...
        },
        {
          ...
          id: 31,
          name: "nidoqueen",
          url: "http://localhost/api/v2/pokemon/31/",
          artwork:
        ...
        },
        {
          ...
          id: 32,
          name: "nidoran-m",
          url: "http://localhost/api/v2/pokemon/32/",
          artwork:
        ...
        },
        {
          ...
          id: 33,
          name: "nidorino",
          url: "http://localhost/api/v2/pokemon/33/",
          artwork:
        ...
        },
        {
          ...
          id: 34,
          name: "nidoking",
          url: "http://localhost/api/v2/pokemon/34/",
          artwork:
        ...
        },
        {
          ...
          id: 35,
          name: "clefairy",
          url: "http://localhost/api/v2/pokemon/35/",
          artwork:
        ...
        },
        {
          ...
          id: 36,
          name: "clefable",
          url: "http://localhost/api/v2/pokemon/36/",
          artwork:
