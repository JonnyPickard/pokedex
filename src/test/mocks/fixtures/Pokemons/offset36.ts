export const offset36 = {
  data: {
    pokemons: {
      count: 1302,
      next: "http://localhost/api/v2/pokemon/?limit=9&offset=45",
      previous: "http://localhost/api/v2/pokemon/?limit=9&offset=27",
      nextOffset: 45,
      prevOffset: 27,
      params: {
        limit: 9,
      ...
      results: [
        {
          ...
          id: 37,
          name: "vulpix",
          url: "http://localhost/api/v2/pokemon/37/",
          artwork:
        ...
        },
        {
          ...
          id: 38,
          name: "ninetales",
          url: "http://localhost/api/v2/pokemon/38/",
          artwork:
        ...
        },
        {
          ...
          id: 39,
          name: "jigglypuff",
          url: "http://localhost/api/v2/pokemon/39/",
          artwork:
        ...
        },
        {
          ...
          id: 40,
          name: "wigglytuff",
          url: "http://localhost/api/v2/pokemon/40/",
          artwork:
        ...
        },
        {
          ...
          id: 41,
          name: "zubat",
          url: "http://localhost/api/v2/pokemon/41/",
          artwork:
        ...
        },
        {
          ...
          id: 42,
          name: "golbat",
          url: "http://localhost/api/v2/pokemon/42/",
          artwork:
        ...
        },
        {
          ...
          id: 43,
          name: "oddish",
          url: "http://localhost/api/v2/pokemon/43/",
          artwork:
        ...
        },
        {
          ...
          id: 44,
          name: "gloom",
          url: "http://localhost/api/v2/pokemon/44/",
          artwork:
        ...
        },
        {
          ...
          id: 45,
          name: "vileplume",
          url: "http://localhost/api/v2/pokemon/45/",
          artwork:
