export const offset45 = {
  data: {
    pokemons: {
      count: 1302,
      next: "http://localhost/api/v2/pokemon/?limit=9&offset=54",
      previous: "http://localhost/api/v2/pokemon/?limit=9&offset=36",
      nextOffset: 54,
      prevOffset: 36,
      params: {
        limit: 9,
      ...
      results: [
        {
          ...
          id: 46,
          name: "paras",
          url: "http://localhost/api/v2/pokemon/46/",
          artwork:
        ...
        },
        {
          ...
          id: 47,
          name: "parasect",
          url: "http://localhost/api/v2/pokemon/47/",
          artwork:
        ...
        },
        {
          ...
          id: 48,
          name: "venonat",
          url: "http://localhost/api/v2/pokemon/48/",
          artwork:
        ...
        },
        {
          ...
          id: 49,
          name: "venomoth",
          url: "http://localhost/api/v2/pokemon/49/",
          artwork:
        ...
        },
        {
          ...
          id: 50,
          name: "diglett",
          url: "http://localhost/api/v2/pokemon/50/",
          artwork:
        ...
        },
        {
          ...
          id: 51,
          name: "dugtrio",
          url: "http://localhost/api/v2/pokemon/51/",
          artwork:
        ...
        },
        {
          ...
          id: 52,
          name: "meowth",
          url: "http://localhost/api/v2/pokemon/52/",
          artwork:
        ...
        },
        {
          ...
          id: 53,
          name: "persian",
          url: "http://localhost/api/v2/pokemon/53/",
          artwork:
        ...
        },
        {
          ...
          id: 54,
          name: "psyduck",
          url: "http://localhost/api/v2/pokemon/54/",
          artwork:
