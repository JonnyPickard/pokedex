export const offset54 = {
  data: {
    pokemons: {
      count: 1302,
      next: "http://localhost/api/v2/pokemon/?limit=9&offset=63",
      previous: "http://localhost/api/v2/pokemon/?limit=9&offset=45",
      nextOffset: 63,
      prevOffset: 45,
      params: { limit: 9, offset: 54 },
      results: [
        {
          image:
          ...
          id: 55,
          name: "golduck",
          url: "http://localhost/api/v2/pokemon/55/",
          artwork:
        ...
        },
        {
          ...
          id: 56,
          name: "mankey",
          url: "http://localhost/api/v2/pokemon/56/",
          artwork:
        ...
        },
        {
          ...
          id: 57,
          name: "primeape",
          url: "http://localhost/api/v2/pokemon/57/",
          artwork:
        ...
        },
        {
          ...
          id: 58,
          name: "growlithe",
          url: "http://localhost/api/v2/pokemon/58/",
          artwork:
        ...
        },
        {
          ...
          id: 59,
          name: "arcanine",
          url: "http://localhost/api/v2/pokemon/59/",
          artwork:
        ...
        },
        {
          ...
          id: 60,
          name: "poliwag",
          url: "http://localhost/api/v2/pokemon/60/",
          artwork:
        ...
        },
        {
          ...
          id: 61,
          name: "poliwhirl",
          url: "http://localhost/api/v2/pokemon/61/",
          artwork:
        ...
        },
        {
          ...
          id: 62,
          name: "poliwrath",
          url: "http://localhost/api/v2/pokemon/62/",
          artwork:
        ...
        },
        {
          ...
          id: 63,
          name: "abra",
          url: "http://localhost/api/v2/pokemon/63/",
          artwork:
      ...
      extended_results: [
        { id: 55, weight: 766, height: 17, __typename: "Pokemon" },
        { id: 56, weight: 280, height: 5, __typename: "Pokemon" },
        { id: 57, weight: 320, height: 10, __typename: "Pokemon" },
        { id: 58, weight: 190, height: 7, __typename: "Pokemon" },
        { id: 59, weight: 1550, height: 19, __typename: "Pokemon" },
        { id: 60, weight: 124, height: 6, __typename: "Pokemon" },
        { id: 61, weight: 200, height: 10, __typename: "Pokemon" },
        { id: 62, weight: 540, height: 13, __typename: "Pokemon" },
        { id: 63, weight: 195, height: 9, __typename: "Pokemon" },
      ],
      status: true,
      message: "",
